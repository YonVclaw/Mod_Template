...
def main():
    ...
    print("""
  ######################################
  # X0X Development Environment Setup #
  ######################################

  This script will create your X0X dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your X0X project folder:
    [Arma 3 installation directory]\\{} => X0X project folder
    P:\\{}                              => X0X project folder
